...
CREATE TABLE `ARWarrantyOrder` (
  ...
  `warrantyno` varchar(100) DEFAULT NULL,
  ...
  `warranty_qty` decimal(15,8) DEFAULT NULL,
  `receipted_qty` decimal(15,8) DEFAULT NULL,
  `remain_qty` decimal(15,8) DEFAULT NULL,
