...
CREATE TABLE `CAIssue` (
  ...
  `to_cardno` varchar(20) DEFAULT NULL,
  `to_bank` varchar(255) DEFAULT NULL,
  `to_bankstate` varchar(255) DEFAULT NULL,
  `to_bankbranch` varchar(255) DEFAULT NULL,
  `to_bankacc` varchar(255) DEFAULT NULL,
  `to_bankacc_owner` varchar(255) DEFAULT NULL,
